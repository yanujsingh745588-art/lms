...
const CourseDetail = () => {
  ...
  return courseData ?(
    ...
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-32 pt-20 text-left">
      ...
      {/*right column*/}
      <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] border border-gray-200 shadow-md">
        {playerData?
        ...
        <div className="p-5">
          ...
          <div className="flex gap-3 items-center pt-2">
            <p className="text-gray-800 md:text-xl text-2x1 font-semibold ">${(courseData.coursePrice- courseData.discount* courseData.coursePrice/100).toFixed(2)}</p>
            <p className="md:text-base text-gray-500 line-through">${courseData.coursePrice}</p>
            <p className="md:text-baseq text-gray-500">{courseData.discount}% off</p>
          </div>
          ...
          <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                <li>Lifetime access with free updates.
